...
public class TbUser implements Serializable {
    ...
    private Double useMoney1;

    private Double useMoney2;
    ...
    public Long getRescueWangId() {
        return rescueWangId;
    }

    public void setRescueWangId(Long rescueWangId) {
        this.rescueWangId = rescueWangId;
    }
    ...
    public String getIdContrary() {
        return idContrary;
    }

    public void setIdContrary(String idContrary) {
        this.idContrary = idContrary == null ? null : idContrary.trim();
    }
    ...
    public Double getUseMoney1() {
        return useMoney1;
    }

    public void setUseMoney1(Double useMoney1) {
        this.useMoney1 = useMoney1;
    }

    public Double getUseMoney2() {
        return useMoney2;
    }

    public void setUseMoney2(Double useMoney2) {
        this.useMoney2 = useMoney2;
    }
