...
public interface TbVehicleService {
    //查询
    List<TbVehicle> findTbVehicleList(Integer page, Integer size,Long brandId,Integer modelType,String branchName,Long vehicleId,Integer state,String start,String end,String ks,String js);

    List<TbVehicle> TbVehicleexal(Long brandId,Integer modelType,String branchName,Long vehicleId,Integer state);
    ...
    //网点退回的车电
    List<TbVehicle> wangReturnTbVehicleList(Integer page, Integer size, Long branchId,Long brandId,Integer modelType,String serialNumber);
    //查询车电型号
    ...
    //查询分公司已入库的车电
    List<HashMap> okTbVehicleList(Integer page, Integer size, Long branchId,Integer brandId,Integer modelType,String branchName,String state,Integer tName,String start,String end,String ks,String js);
    ...
    //该公司的发票
    List<TbInvoice> findRes(Integer page, Integer size);
