...
(/** @lends <global> */function( $ ) {
	 ...
	 *  @param {object} src The templates.model object which holds all parameters that can be
	 *    mapped.
	...
	/*
	 * Developer note - See note in templates.model.defaults.js about the use of Hungarian
	...
	// Built in type detection. See templates.model.ext.aTypes for information about
	...
	// Filter formatting functions. See templates.model.ext.ofnSearch for information about
